...
import edu.jetsetmagazine.dao.MailConstruction;
...
public class MailJframe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonSendMail.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/jetsetmagazine/gui/envoyermail.jpg"))); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/jetsetmagazine/gui/mail.jpg"))); // NOI18N

        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/jetsetmagazine/gui/home.png"))); // NOI18N
        ...
        jButton1.setText("Attacher piéce");
    ...
    private void jButtonSendMailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSendMailActionPerformed
        ...
        String s="";
        if (url!=null)  s= this.cleanUrl(url);
        if (s.equals(""))mc.getMailMessage(mail);else mc.getMailMessage(s,mail);
        mc.SendMessage();
